...
const defaultItems = [
    { letter: "C", icon: <FaGithub />, label: "Github", href: "https://github.com/Apurvasri25" },
    { letter: "O", icon: <FaWhatsapp />, label: "WhatsApp", href: "https://wa.me/919345128436" },
    { letter: "N", icon: <FaLinkedin />, label: "LinkedIn", href: "https://www.linkedin.com/in/apurvasri-k-921876293" },
    { letter: "T", icon: <FaFileAlt />, label: "Resume", href: "/resume.pdf" },
    { letter: "A", icon: <FaPhone />, label: "Cell", href: "tel:+919345128436" },
    { letter: "C", icon: <FaEnvelope />, label: "Email", href: "mailto:apurvasrikanakasabapathi@gmail.com" },
    { letter: "T", icon: <FaCode />, label: "Projects", href: "https://github.com/Apurvasri25" },
];
